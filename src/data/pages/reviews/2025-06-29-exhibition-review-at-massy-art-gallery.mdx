...
import Landscape1 from "@/assets/images/20220722_114815.jpg";
import Landscape2 from "@/assets/images/20220723_193910.jpg";
import Landscape3 from "@/assets/images/20220723_193856.jpg";
import Paper from "@/assets/images/05f2075e-9a16-4015-91d4-941ca975e982.webp";
...
<Image src={Paper}  height={400} class="snap-start m-auto" alt="paper painting"/>
...
<div class="flex space-x-2 container-fullbreak snap-start w-full">
    <Image src={Landscape1} alt="Landscape1" height={400} class="hidden sm:block flex-grow-1 object-cover" />
    <Image src={Landscape2} alt="Landscape2" height={400} class="hidden sm:block flex-grow-1 object-cover" />
    <Image src={Landscape3} alt="Landscape3" height={400} class="flex-grow-1 object-cover" />
</div>
